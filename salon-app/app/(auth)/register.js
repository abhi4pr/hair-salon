...
export default function Register() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      Toast.show({ type: 'success', text1: 'Registration successful', text2: 'Please verify your email' });
      router.push({ pathname: '/(auth)/verify-otp', params: { email: form.email.trim().toLowerCase() } });
    } catch (err) {
      ...
      >
        ...
        <View style={[styles.card, { backgroundColor: theme.card, shadowColor: theme.shadow }]}>
          ...
          <Input
            ...
            error={errors.name}
            leftIcon={<Ionicons name="person-outline" size={18} color={theme.icon} />}
          />
          <Input
          ...
          <Input
            ...
            error={errors.phone}
            leftIcon={<Ionicons name="call-outline" size={18} color={theme.icon} />}
          />
          <Input
